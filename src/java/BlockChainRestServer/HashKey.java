 ...
 *
 * @author chentianxin
 * HashKey is a program to read any input and compute a SHA-256 hash.
 * The program returns the whole hex-digits taken from the
 * leftmost all bytes of the SHA-256 Hash.
 */
